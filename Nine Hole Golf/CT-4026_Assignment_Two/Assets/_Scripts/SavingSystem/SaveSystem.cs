...
public static class SaveSystem {
	public static void SaveData(SaveNameScript player) {
		...
		PlayerClass data = new PlayerClass(player);
	...
	public static PlayerClass LoadData() {
		...
		if (File.Exists(path)) {
			...
			PlayerClass data = formatter.Deserialize(stream) as PlayerClass;
			stream.Close();
			return data;
		} else {
